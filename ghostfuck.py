...
def shutdown():
	print ""
	print bcolors.BGRED + bcolors.WHITE + t() + "[info] shutting down ghostfuck" + bcolors.ENDC +"\n\n"
	sys.exit()
...
def usage():
	...
	python ghostfuck switch ----(switch IP)
...
def stop_ghostfuck():
	print bcolors.RED+t()+"STOPPING ghostfuck"+bcolors.ENDC
